...
const downloadMp3 = (params: IDownloadYTParams) => {
...
const downloadMp4 = (params: IDownloadYTParams) => {
    const { videoURL, ytdlOut, ytdlError, ytdlExitSuccess, ytdlExitFailure } = params;
    ...
    // Random filename for processing
    const fileUUID = crypto.randomUUID();
    const outputFilePath = `/app/tmp/${videoID}-${fileUUID}-out.mp4`;
